...
for i=1:m1
    for j=1:n1
        ...
        elseif(value >= 240 && value <246)
            h(42,1)=h(42,1)+1;
        elseif(value >= 246 && value <250)
            h(43,1)=h(43,1)+1;
        elseif(value >= 250 && value <255)
            h(44,1)=h(44,1)+1;
        end
    end
end
        ...
        for ii=1:m11
            for jj=1:n11
                ...
                elseif(value1 >= 240 && value1 <246)
                    h1(42,1)=h1(42,1)+1;
                elseif(value1 >= 246 && value1 <250)
                    h1(43,1)=h1(43,1)+1;
                elseif(value1 >= 250 && value1 <255)
                    h1(44,1)=h1(44,1)+1;
                end
            end
        end
...
figure(2);
imshow(image_temp);
imwrite(image_temp,'watermarked.jpg','jpg');
